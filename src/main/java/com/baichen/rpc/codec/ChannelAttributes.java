...
public final class ChannelAttributes {
    public static final AttributeKey<Byte> SERIALIZER_KEY = AttributeKey.valueOf("serializer_key");
    public static final AttributeKey<Byte> COMPRESSOR_KEY = AttributeKey.valueOf("compressor_key");
